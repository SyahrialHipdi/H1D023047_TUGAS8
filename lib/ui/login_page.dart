...
import 'package:pertemuan10/ui/registrasi_page.dart';
import 'package:pertemuan10/bloc/login_bloc.dart';
      ...
      onError: (error) {
        ...
        showDialog(
          ...
          builder: (BuildContext context) => WarningDialog(
            description: error?.toString() ?? "Login gagal, silahkan coba lagi",
          ),
        );
      },
    );
